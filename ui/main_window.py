...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_5.addWidget(self.Tips, 0, 4, 5, 1)
        ...
        self.login_out.setMaximumSize(QtCore.QSize(120, 16777215))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        ...
        self.gridLayout_6.addItem(spacerItem11, 8, 1, 1, 1)
        ...
        self.localService = QtWidgets.QCheckBox(self.widget)
        self.localService.setMinimumSize(QtCore.QSize(0, 27))
        self.localService.setObjectName("localService")
        self.gridLayout_7.addWidget(self.localService, 0, 0, 1, 1)
        self.labelConverter = QtWidgets.QPushButton(self.widget)
        self.labelConverter.setMinimumSize(QtCore.QSize(0, 27))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        self.labelConverter.setFont(font)
        self.labelConverter.setObjectName("labelConverter")
        self.gridLayout_7.addWidget(self.labelConverter, 0, 1, 1, 1)
        self.gridLayout_6.addWidget(self.widget, 6, 1, 1, 1)
...
""))
        ...
        self.labelConverter.setText(_translate("MainWindow", "标签格式转换"))
